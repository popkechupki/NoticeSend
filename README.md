# NoticeSend
Admin Tools plugin for PocketMine-MP.通知送信プラグインです。OPからのみ送信することができます。ゲストは通知を読むことと自分宛の通知を消去することが可能です。使用する際には以下のライセンスに同意した上での使用をお願いします。
##How to use
通知を送信：/notice send <player> <message>
通知を読む：/read
通知を削除：/del
##popke LICENSE
